...
public class GitHubCodeSearch {
    ...
    private static String generateQuery(String keyword, String organization) {
        return String.format("%s+org:%s+is:public+archived:false", toCaseInsensitiveRegex(keyword), organization);
    }

    private static String toCaseInsensitiveRegex(String keyword) {
        return String.format("(?i)%s", keyword);
    }
